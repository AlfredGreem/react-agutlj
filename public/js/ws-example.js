...
function addRowToTable(data) {
    ...
    $('#bucket-'+network+' tr:first').before('<tr><td><a href="https://sochain.com/tx/'+network+'/'+data.txid+'" target=_blank>'+data.txid.substring(0,8)+'...</a></td><td>'+sumSent.toFixed(4)+' '+coinSymbols[network]+'</td></tr>');
